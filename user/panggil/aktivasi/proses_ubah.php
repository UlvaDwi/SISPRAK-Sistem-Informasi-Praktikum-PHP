...
if(ISSET($_POST['update'])){	
	...
	//proses simpan
		...
		{
			$conn = new db_class();
			$conn->update($kode_asprak , $nama_asprak, $jk_asprak , $foto_baru , $telp_asprak , $email_asprak , $pass_asprak);
			header('location: ../../index.php?lihat=asprak/index');
		}
	}
	else{
		$conn = new db_class();
			$conn->update_tanpa_foto($kode_asprak , $nama_asprak, $jk_asprak , $telp_asprak , $email_asprak , $pass_asprak);
			header('location: ../../index.php?lihat=asprak/index');
	}

...
////////////////////////////
			...
			<div class = "row">	
				...
				<div class = "col-lg-6">
					...
					<form method="POST" action="<?php echo $action; ?>" >
						...
						<input class="btn btn-primary btn-sm" type="submit" name="sav" value="<?php echo $button ?>">
					</form>
				</div><!-- .col-lg-6 -->
				<div class = "col-lg-3"></div>
			</div><!-- .row -->
	...
	<?php 
}else if ($conn ->cek_aktivasi($npm)==1){
	?>
	<label>
		MAAF, Aktivasi anda belum diterima, silahkan cek aktivasi <a href="index.php?lihat=Aktivasi/index">disini</a> atau hubungi admin di ruang lab	
	</label>
	<?php
}else{
	?>
	<label>
	anda belum melakukan aktivasi, silahkan melakukan pembayatan dan upload file aktivasi <a href="index.php?lihat=Aktivasi/index">disini</a>
	</label>
	<?php

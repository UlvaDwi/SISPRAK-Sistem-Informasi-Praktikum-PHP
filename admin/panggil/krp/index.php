						...
						///////////////////
							...
							<tr>
								...
								<td>
									...
									<?php echo "kode jadwal praktikum: ". $tampil_jadwal['kode_jadwal_praktikum']." Kelas ".$tampil_jadwal['nama_kelas'].", ".$tampil_jadwal['hari']." ".$tampil_jadwal["jam_mulai"]."-".$tampil_jadwal["jam_akhir"]."</br>".$tampil_jadwal["nama_lab"]."(".$tampil_jadwal["kapasitas_lab"].")"." Pemateri : ".$tampil_jadwal["nama_asprak"]."</br>".$a."  ".$linkHapus; ?>
				...
				foreach ($pilihan_jadwal as $tampil) {
					...
					<tr>
						...
						<td style="text-align: center;">
							<a onclick="return confirm('Apakah yakin data akan di hapus?')" href="<?= $link.'hapus&npm='.$npm.'&id='.$tampil['kode_jadwal_praktikum'] ?>" class="btn btn-danger btn-sm">
